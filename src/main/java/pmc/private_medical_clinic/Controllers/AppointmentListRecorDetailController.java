...
@RestController
@RequestMapping("api/v1/appointmentrecorddetails")
@CrossOrigin(origins = "*")
public class AppointmentListRecorDetailController {
    ...
    public boolean deleteAppointmentListRecordDetail(@PathVariable("id") Long id) {
     ...
     @ResponseBody
    @GetMapping("/appointmentRecordId/{appointmentRecordId}")
    public List<AppointmentListRecordDetail> getDetailByAppointmentRecordId(@PathVariable("appointmentRecordId") Long appointmentRecordId) {
        return appointmentListRecordDetailService.getDetailByAppointmentRecordId(appointmentRecordId);
    }
}
