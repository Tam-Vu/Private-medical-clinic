...
public class ArgumentController {
    ...
    public Long updateMaxNumOfPatients(@RequestBody Long maxNumOfPatients) {
        return argumentService.updateMaxNumOfPatients(maxNumOfPatients);
    }
    @ResponseBody
    @PutMapping("update/feeConsult")
    public Long updateFeeConsult(@RequestBody Long feeConsult) {
        return argumentService.updateFeeConsult(feeConsult);
    }
}
